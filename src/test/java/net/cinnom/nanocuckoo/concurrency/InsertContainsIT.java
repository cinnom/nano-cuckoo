 ...
 */
public class InsertContainsIT {

	@Test
	public void insertContainsTest() throws InterruptedException, IOException, ClassNotFoundException {
				...
				while ( true ) {
					...
					if ( i > 100_000 ) {
						...
						if ( !cuckooFilter.contains( c ) ) {
							System.out.println( "Contains failed at: " + ( i / 2 ) );
							failed.set( true );
							break;
						}
					}
