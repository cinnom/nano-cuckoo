 ...
 */
public class InsertDeleteIT {

	@Test
	public void insertDeleteTest() throws InterruptedException, IOException, ClassNotFoundException {
		...
		for ( int th = 0; th < threads; th++ ) {
			Runnable t = () -> {
				...
				while ( true ) {
					...
					Assert.assertTrue( cuckooFilter.contains( s ) );
					if ( i > 100_000 && i % 2 > 0 ) {
